...
**R1【最高優先度】指名文** 「〇〇君。」「〇〇委員。」「〇〇さん。」「〇〇大臣。」「〇〇副大臣。」「〇〇政務官。」だけの短文、役職付き指名文（例:「財務大臣片山さつき君。」）、「続いて〇〇君。」等 → 必ず**委員長**のsplitを作成。指名文の直後に指名された人物の別splitを作成。主発言者の名前でも委員長splitにする。
...
start: 0始まりの文番号、昇順、最初は必ず0。テキストは含めない。
"""

...
## 検出ルール
1. 委員長の指名発言パターン（「〇〇君」「〇〇委員」「〇〇大臣」「〇〇さん」）で話者交代を検出する
...
## 委員長の指名と質疑者の発言の区別（重要）
委員長は「〇〇君。」「〇〇委員。」「〇〇さん。」と短く呼びかけて発言権を与える。これは1文程度の短い指名発言である。
その直後に続く質問・意見・要望の内容は、指名された質疑者本人の発言である。

例: セグメント主発言者が「谷浩一郎」の場合
  - 「谷浩一郎君。」→ 委員長の指名（1文だけ）
  - 「続いて質問いたしますが、少子化は…」→ 谷浩一郎（質疑者）の発言
  - 「ご答弁ありがとうございます。次に…」→ 谷浩一郎（質疑者）の発言

委員長の指名（「〇〇君。」等）の後に政策への質問・意見・要望が続く場合、それは委員長ではなくセグメント主発言者の質疑である。委員長自身の発言は指名・議事進行（「質疑の申し出がありますので…」「時間が来ております」等）に限られる。

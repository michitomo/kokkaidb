...
**R1【最高優先度】指名文** 「〇〇君。」「〇〇大臣。」「続いて〇〇君。」等の短文・役職付き指名文 → **委員長**のsplitを作成。直後に指名された人物の別splitを作成。

**R2: Whisperラベル行** 「〇〇委員長：text」等コロン付き行、または「〇〇（役職名）」のみの行 → その番号からその話者の発言開始。line 0が非ラベルでline 1がラベルの場合、line 0はラベル話者に帰属。

**R3: 答弁冒頭の定型句** 「お答えいたします」「お答え申し上げます」「御指摘の点について」等 → 答弁者または政府参考人。

**R4: 継続** R1〜3非該当文は直前の話者の継続。発言内の他者名は話者交代ではない。

## 役割（role）

| role | 対象 |
|------|------|
| 委員長 | 委員長・副委員長・議長の議事進行・指名 |
| 質疑者 | 委員・議員の質問（大臣等には使わない） |
...
## 過剰分割の防止
- R1〜3に明確に該当する場合のみsplitを作成。同一話者は1 splitに統合
